...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    try {
      ...
      console.error('[api] GET /sports/matches:', msg);
  ...
  if (req.method === 'POST') {
    ...
    try {
      ...
      const msg = e instanceof Error ? e.message : String(e);
      console.error('[api] POST /sports/matches:', msg);
  ...
  if (req.method === 'DELETE') {
    ...
    try {
      ...
      const msg = e instanceof Error ? e.message : String(e);
      console.error('[api] DELETE /sports/matches:', msg);
